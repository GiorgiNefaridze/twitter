...
export default function NavigationBar() {
    return (
        <div className='NavigationBar-container'>
            ...
            <div className="NavigationBar-container-home list-item">
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
            ...
            <div className='NavigationBar-container-explore list-item'>
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
            ...
            <div className="NavigationBar-container-notification list-item">
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
            ...
            <div className="NavigationBar-container-messages list-item">
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
            ...
            <div className='NavigationBar-container-profile list-item'>
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
            ...
            <div className="NavigationBar-container-more list-item">
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
            ...
            <button>Tweet</button>
            <div className="NavigationBar-container-user">
                <img src={Avatar}/>
                <div className="email">
                    <span>giorgi nefaridze</span>
                    <h4>@giorgi</h4>
                </div>
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="user-dots r-18jsvk2 r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                    <g>
